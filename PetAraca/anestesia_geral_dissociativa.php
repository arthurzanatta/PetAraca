        ...
        <div class="row">
            ...
            <div class="conteudo col-6">
                <h2 align="center">ANESTESIA GERAL E ANESTESIA DISSOCIATIVA</h2></br>
                    ...
                    aminobutírico (GABA). A indução anestésica pode ser realizada pela inalação do agente inalatório com o auxílio da máscara, porém pode
                    levar à excitação. Após a indução anestésica e o com o paciente em plano anestésico, ou seja, apresentando inconsciência e perda do tônus
                    mandibular, reflexos de deglutição e palpebral é realizado a intubação com a sonda endotraqueal. Esta sonda estará conectada ao aparelho
                    de anestesia inalatória, e é por meio desta que é administrado oxigênio a 100% e o agente inalatório. Durante todo o procedimento os
                    parâmetros vitais dos animais são monitorados através do monitor multiparamétrico e anotados na ficha anestésica. Os agentes inalatórios
                    apresentam pouca metabolização hepática e excreção renal, promovem anestesia geral e depressão cardiorrespiratória dose dependente,
                    assim são considerados seguros. A anestesia geral leva a inconsciência, mas não promove analgesia, sendo assim é necessário a
                    administração de opióides e associação de técnicas de bloqueios locais. Após o termino da cirurgia são administrados medicamentos
                    ...
                    <p align="center" style="font-size:14px;">Residência em Anestesiologia Animal (2019) pela UNESP – Araçatuba</p>
            </div>
